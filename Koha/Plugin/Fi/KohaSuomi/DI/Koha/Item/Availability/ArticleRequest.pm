package Koha::Plugin::Fi::KohaSuomi::DI::Koha::Item::Availability::ArticleRequest;
...
my $requestable = Koha::Plugin::Fi::KohaSuomi::DI::Koha::Item::Availability::ArticleRequest->new({
