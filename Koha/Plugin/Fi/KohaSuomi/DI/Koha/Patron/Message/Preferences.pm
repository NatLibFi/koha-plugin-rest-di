package Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Preferences;
...
use Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Preference;
...
Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Preferences - Koha Patron Message Preferences object class
...
sub get_options {
    ...
    my $transports = Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Transports->search(undef,
        {
...
sub TO_JSON {
    ...
    foreach my $option (@$options) {
        unless ($preferences->{$option->{'message_name'}}) {
            my $message_attribute_id = Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Attributes->find({
                message_name => $option->{'message_name'}
            })->message_attribute_id;
            $preferences->{$option->{'message_name'}} =
                Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Preference->new({
                    borrowernumber => -1,
...
sub object_class {
    return 'Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Preference';
}
