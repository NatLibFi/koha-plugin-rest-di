...
my $preference = Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Preference->new_from_default({
    borrowernumber => 123,
...
Throws Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::MissingParameter if any of following is missing:
- borrowernumber
...
sub new_from_default {
    ...
    my $default = Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Preferences->find({
...
sub fix_misconfigured_preference {
    ...
    my $options = Koha::Plugin::Fi::KohaSuomi::DI::Koha::Patron::Message::Preferences->get_options;
    my $opt;
    ...
    foreach my $mtt (keys %{$self->message_transport_types}) {
        ...
        if ($mtt_to_patronfield_to_validator->{$mtt}) {
            ...
            if ($patron->$field && Koha::Plugin::Fi::KohaSuomi::DI::Koha::Validation->$v($patron->$field)) {
                push @{$valid_mtts}, $mtt;
            }
        }
        else {
