package Koha::Plugin::Fi::KohaSuomi::DI::Koha::Availability::Checks::Patron;
...
Returns Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::Debarred if patron is debarred.
...
sub debarred {
    ...
    if ($patron->is_debarred) {
        return Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::Debarred->new(
...
Returns Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::Debt if patron has outstanding fines that
...
sub debt_checkout {
    ...
    if (C4::Context->preference('AllFinesNeedOverride') && $amount > 0) {
        ...
        return Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::Debt->new(
...
Returns Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::DebtGuarantees if patron's guarantees are
...
Returns Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Hold::MaximumHoldsReached if the total amount of
...
Returns Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::CardExpired if patron's card has been expired.
...
Returns Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::FromAnotherLibrary if patron is from another
    ...
    if (C4::Context->preference("IndependentBranches")) {
        ...
        unless (C4::Context->IsSuperLibrarian()) {
            if ($patron->branchcode ne $userenv->{branch}) {
                return Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::FromAnotherLibrary->new(
...
Returns Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::GoneNoAddress if patron is gonenoaddress.
...
sub gonenoaddress {
    ...
    if ($self->patron->gonenoaddress) {
        return Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::GoneNoAddress->new;
    }
    return;
}
...
Returns Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::CardLost if patron's card is marked as lost.
...
sub lost {
    ...
    if ($self->patron->lost) {
        return Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::CardLost->new;
    }
    return;
}
...
Returns Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::DebarredOverdue if patron is debarred because
...
sub overdue_checkouts {
    ...
    if ($number = $self->patron->has_overdues) {
        return Koha::Plugin::Fi::KohaSuomi::DI::Koha::Exceptions::Patron::DebarredOverdue->new(
